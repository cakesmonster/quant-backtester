...
│  ┌──────────────────────┐  ┌──────────────────────────┐ │
│  │ 昨日涨停今日表现      │  │ 竞价异动（仅当天显示）    │ │
│  │ +2.3%  涨停5 红盘12  │  │ 09:20 600xxx 诱多⚠      │ │
│  │ 绿盘8  跌停3         │  │ 09:23 000xxx 弱转强🟢   │ │
│  └──────────────────────┘  └──────────────────────────┘ │
│                                                         │
│  ┌────────────────────────────────────────────────────┐ │
│  │ 连板天梯                                          │ │
│  │                                                    │ │
│  │ 5连板  600xxx 某某股份 [芯片] +10.0% 换18.7%⚠ 量2.1│ │
│  │    [hover: 市值580亿 流通320亿 PE45.2 概念:...]    │ │
│  │ 4连板  000xxx 某某科技 [新能源] +9.98%             │ │
│  │ 3连板  600yyy 某龙头 [军工] +10.0%                │ │
│  │ 2连板  ...                                        │ │
│  │ 首板   ...                                        │ │
│  │ ── 淘汰 ──                                        │ │
│  │ 600zzz 某某电子 [昨日涨停] 今日 -3.2% 灰色        │ │
│  └────────────────────────────────────────────────────┘ │
│                                                         │
│  ┌────────────────────────────────────────────────────┐ │
│  │ 板块攻击路线（资金流向）                            │ │
...
│  │ 低空经济    +3.6%  ████████         存储    -2.1%  │ │
│  │                                                    │ │
│  │ 切换趋势：资金从半导体/芯片撤离 → 涌向机器人/航天  │ │
│  └────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────┘
```

**连板天梯 hover 展示：** 市值、流通市值、市盈率、换手率、量比、概念标签。**淘汰股**灰色显示，标注昨日涨停、今日涨跌幅。

**板块攻击路线：** 展示全市场板块涨跌幅排行，一眼看出资金在板块间的切换方向。不只涨停股——所有板块的涨跌趋势。
...
CREATE TABLE daily_sentiment (
    ...
    promotion_rate REAL,        -- 连板晋级率
    yday_avg_return REAL,       -- 昨日涨停今日均收益
    yday_cont_up INTEGER,       -- 昨日涨停今日继续涨停
    yday_red INTEGER,           -- 昨日涨停今日红盘
    yday_green INTEGER,         -- 昨日涨停今日绿盘
    yday_limit_down INTEGER     -- 昨日涨停今日跌停
);
